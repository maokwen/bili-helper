...
public class VersionInfo {
    ...
    private static String projectRepo = "https://github.com/maokwen/bili-backup";
    ...
    public static void printVersionInfo() {
        initInfo();
        JsonObject jsonObject = HttpUtils.doGet("https://api.github.com/repos/maokwen/bili-backup/releases/latest");
        log.info("-----版本信息-----");
